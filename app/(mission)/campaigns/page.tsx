        ...
        <div className="mt-4 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-slate-400">
              ...
              operating plan for turning territory intelligence into field execution.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-amber-400/20 bg-amber-400/10 px-6 py-4 text-right">
            ...
            <div className="text-5xl font-black text-white">{report.readiness}</div>
          </div>
        </div>
      </GlassPanel>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_.8fr]">
        <div className="space-y-6">
          <GlassPanel className="p-6">
            <h3 className="text-2xl font-black text-white">Mission Objectives</h3>
        ...
        <GlassPanel className="p-6">
          ...
          <div className="mt-6 space-y-3">
            ...
            <MissionMetric label="Strongest Signal" value={report.strongestSignal} />
